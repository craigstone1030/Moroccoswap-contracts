// File: contracts/Farm/IERC20MetaData.sol
...
// File: contracts/Farm/MoroccoUSDTXBank.sol
...
contract MoroccoUSDTXBank is Ownable {
    ...
    IERC20MetaData public token; //staking token
    bool public paused;
    ...
    constructor(IERC20MetaData _staking) public {
        token = _staking;
    }

    function addrewardtoken(IERC20MetaData rewardToken, uint256 amount) public {
    ...
    function deposit(uint256 _amount) public isPaused {
        ...
        token.transferFrom(address(_userAddr), address(this), _amount);
    ...
    function _claimReward(UserInfo storage user, address rewardToken) private {
        ...
        if (user.amount > 0) {
            ...
            safeRewardTransfer(IERC20MetaData(rewardToken), _userAddr, pendingReward);
        }
    ...
    function withdraw(uint256 _amount) public isPaused {
        ...
        token.transfer(address(_userAddr), _amount);
