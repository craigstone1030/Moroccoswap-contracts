...
// File: contracts/Farm/MoroccoGoldXBank.sol
...
contract MoroccoGoldXBank is Ownable {
    ...
    function _claimReward(UserInfo storage user, address rewardToken) private {
        ...
        if (user.amount > 0) {
            ...
            safeRewardTransfer(IERC20MetaData(rewardToken), _userAddr, pendingReward.div(IERC20MetaData(rewardToken).decimals()));
        }
